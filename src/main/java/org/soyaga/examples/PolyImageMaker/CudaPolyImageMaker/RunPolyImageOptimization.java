...
import org.soyaga.examples.PolyImageMaker.CudaPolyImageMaker.Mutations.*;
...
public class RunPolyImageOptimization {
    public static void main(String ... args) throws IOException {
        ...
        String imageToRecreate = "PolyImageMaker/galaxy.jpg";
        ...
        //String with the path to the image we want to recreate.
        String cudaFileNamePath = "src/main/java/org/soyaga/examples/PolyImageMaker/CudaPolyImageMaker/Kernel/JCudaColorDistance.cu";
