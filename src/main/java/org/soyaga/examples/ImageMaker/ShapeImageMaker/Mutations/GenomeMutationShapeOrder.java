 ...
 */
@AllArgsConstructor
public class GenomeMutationShapeOrder implements Mutation {
    /**
     * This integer determines the iteration at which the swapping of CustomChromosomes should cease. Generally, this mutation
     * is disabled relatively "early" in the optimization process. This is because the sequence in which we arrange the shapes
